...
class Module final : public Statement {
 public:
  ...
  void AddObj(Uptr<Create> &&obj) { objs.push_back(std::move(obj)); }
};
...
class Block final : public Statement {
 public:
  ...
  Block() = default;
  Block(Uptr<Statement> &&statement) {
  ...
  void AddStatement(Uptr<Statement> &&statement) {
...
class If final : public Statement {
 public:
  ...
  void SetOrelse(Uptr<Block> &&block) { orelse = std::move(block); }
};
...
class Try final : public Statement {
 public:
  ...
  void SetOrelse(Uptr<Block> &&block) { orelse = std::move(block); }
  void AddExcept(std::tuple<Uptr<TextType>, Uptr<Name>, Uptr<Block>> &&except) {
